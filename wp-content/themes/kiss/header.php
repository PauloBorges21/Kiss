    ...
    <div data-collapse="medium" data-animation="default" data-duration="400" class="nav-bar w-nav">
      <div class="container container-navbar w-container">
        ...
        <nav role="navigation" class="nav-menu w-clearfix w-nav-menu">
          <div class="nav-esq"><a href="#participar" class="nav-link w-nav-link">COMO
              PARTICIPAR</a>
              <a href="#premios" class="nav-link w-nav-link">PRÊMIOS</a>
              <a href="#faq" class="nav-link w-nav-link">DÚVIDAS</a>
            <a href="#regulamento" class="nav-link w-nav-link">REGULAMENTO</a>
            <a href="#ganhadores" class="nav-link w-nav-link">GANHADORES</a>
          </div>
